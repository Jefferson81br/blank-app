...
def renderizar_tela(supabase, user):
    ...
    def linha_f(label, key, bloqueia_sistema=False):
        ...
        # Define o valor do sistema (0 e desabilitado se for Saída)
        ...
        # Cálculo de acerto: conferência menos sistema
    ...
    # --- GRUPO 2: SAÍDAS ---
    st.subheader("📤 Saídas")
    # Para saídas, o acerto é tratado como negativo da conferência no total final
    ...
    # Conferência Líquida: Entradas - Saídas
